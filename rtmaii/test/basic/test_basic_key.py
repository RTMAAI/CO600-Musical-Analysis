...
class TestSuite(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.off_f5_freq = {'midi_num': 77, 'frequency': 690, 'note': 'F', 'actual_frequency': 698.46, 'cents_off': -15}
    ...
    def test_a4sharp_midi(self):
        """ Test that the the midi number calculated for a frequency is correct. """
        self.assertEqual(key.get_midi_num(self.a4sharp_freq['frequency']), self.a4sharp_freq['midi_num'])
    ...
    def test_cents_off(self):
        ...
        self.assertEqual(key.get_cents_off(self.off_f5_freq['frequency'], self.off_f5_freq['midi_num']), self.off_f5_freq['cents_off'])
